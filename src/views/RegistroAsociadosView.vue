...
<template>
  <div class="content page-wrapper bg-gra-03 p-t-45 p-b-50">
    <div class="wrapper wrapper--w790">
      <div class="card card-5">
        <div class="card-heading">
          <h2 class="title">Registro de Asociados</h2>
        </div>
        <div class="card-body">
          <form>
            ...
            <div class="form-row p-t-20">
              <div class="name">¿Tiene hijos?</div>
              <div class="value">
                <div class="row row-refine">
                  <div class="col-5">
                    <div class="p-t-15">
            ...
            <div class="form-row p-t-20">
              <div class="name">¿Actualmente trabaja?</div>
              <div class="value">
                <div class="row row-refine">
                  <div class="col-5">
                    <div class="p-t-15">
...
.bg-gra-03 {
  ...
  background: -webkit-linear-gradient(bottom left, #f9f9f9 0%, #d0d0d0 100%);
  background: -moz-linear-gradient(bottom left, #f9f9f9 0%, #d0d0d0 100%);
  background: -o-linear-gradient(bottom left, #f9f9f9 0%, #d0d0d0 100%);
  background: linear-gradient(to top right, #f9f9f9 0%, #d0d0d0 100%);
}
